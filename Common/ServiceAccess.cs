...
namespace SFALibrary.Common
{
    ...
    public class DatabaseAccess
    {
        ...
        public Object deserializeToDomain(string fileName, string dataObject)
        {
            ...
            {
                case "LIQTRNS":
                    obj = (Object)javaScriptSerializer.Deserialize<LiquidTransfer>(dataObject);
                    break;
                case "PLANT":
                    obj = (Object)javaScriptSerializer.Deserialize<Plant>(dataObject);
                    break;
                case "BTLTYPE":
                    obj = (Object)javaScriptSerializer.Deserialize<BottleType>(dataObject);
                    break;
                case "VEHICLE":
                    obj = (Object)javaScriptSerializer.Deserialize<Vehicle>(dataObject);
                    break;
                case "LOCATION":
                    obj = (Object)javaScriptSerializer.Deserialize<Location>(dataObject);
                    break;
                case "LOCTRANS":
                    obj = (Object)javaScriptSerializer.Deserialize<LocationTransfer>(dataObject);
                    break;
                case "LIQTYPE":
                    obj = (Object)javaScriptSerializer.Deserialize<LiquidType>(dataObject);
                    break;
                case "SOLUTE":
                    obj = (Object)javaScriptSerializer.Deserialize<Solute>(dataObject);
                    break;
                case "SOLTION":
                    obj = (Object)javaScriptSerializer.Deserialize<Solution>(dataObject);
                    break;
                case "SINTAKE":
                    obj = (Object)javaScriptSerializer.Deserialize<LiquidInput>(dataObject);
                    break;
                case "MEASUR":
                    obj = (Object)javaScriptSerializer.Deserialize<ContainerCalculation>(dataObject);
                    break;
                case "BOTBAT":
                    obj = (Object)javaScriptSerializer.Deserialize<BottlingBatch>(dataObject);
                    break;
                case "CONTAIN":
                    obj = (Object)javaScriptSerializer.Deserialize<Container>(dataObject);
                    break;
                case "MATYPE":
                    obj = (Object)javaScriptSerializer.Deserialize<MachineType>(dataObject);
                    break;
                case "DISLATE":
                    obj = (Object)javaScriptSerializer.Deserialize<Distillation>(dataObject);
                    break;
                case "MACHINE":
                    obj = (Object)javaScriptSerializer.Deserialize<Machine>(dataObject);
                    break;
                case "COTRANS":
                    obj = (Object)javaScriptSerializer.Deserialize<MachineContainerTransfer>(dataObject);
                    break;
                case "ALCMETR":
                    obj = (Object)javaScriptSerializer.Deserialize<AlcoholoMetric>(dataObject);
                    break;
                case "COTYPE":
                    obj = (Object)javaScriptSerializer.Deserialize<ContainerType>(dataObject);
                    break;
                case "VATGAG":
                    obj = (Object)javaScriptSerializer.Deserialize<GaugedVat>(dataObject);
                    break;
                case "DCSLUSER":
                    obj = (Object)javaScriptSerializer.Deserialize<User>(dataObject);
                    break;
                default:
                    break;
            }
